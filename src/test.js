...
// //----------------------------------------------------------------------------------------------------
let token_pair = "BNBUSDC";
const leverage = 3;
const tigger_option = 2;
...
const debt_ratio_threshold = 0.35; // TBD
const net_delta_threshold = 1; // TBD
const time_based_interval = 60 * 60 * 24; // TBD
...
function createData(Return, APY, Sharpe, Drawdown) {
  return { Return, APY, Sharpe, Drawdown };
}
...
//   end_date
// ) {
//   start_date = (new Date(start_date) * 1000) / 1000000;
//   end_date = (new Date(end_date) * 1000) / 1000000;
//   console.log((new Date(start_date) * 1000) / 1000000);
function calculations() {
  ...
  // if (leverage == 3) { ///// issue...
  let DN_split_base = 0.75;
  let DN_split_quote = 0.25;
  // } else {
  //   // Not yet add anything
  // }
  //----------------------------------------------------------------------------------------------------
  ...
  for (let i = 1; i < (end_date - start_date) / interval; i++) {
    ...
    // Tigger 0: Debt_ratio
    //----------------------------------------------------------------------------------------------------
    if (tigger_option == Tigger.Debt_ratio) {
    ...
    // Tigger 1: Net_delta
    //----------------------------------------------------------------------------------------------------
    if (tigger_option == Tigger.Net_delta) {
    ...
    // Tigger 2: Time_based
    //----------------------------------------------------------------------------------------------------
    if (tigger_option == Tigger.Time_based) {
  ...
  let sharpeRatio = (average * Math.sqrt(365)) / standDeviation;
  ...
  maxDrawdown = (maxDrawdown / principal) * 100;

  // console.log(...roi_list);
  // console.log(rebalancePoint);

  //------------------------------------ Turn into Table data ------------------------------------------
  const tableData = [createData(returnROI, APY, sharpeRatio, maxDrawdown)];
  console.log(...data_list_2);
  //----------------------------------------------------------------------------------------------------
  return [data_list_2, tableData]; // return graoh + table data
}
